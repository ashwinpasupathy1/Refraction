"""Scatter plot analyzer — renderer-independent.

Reads XY Excel data (first column = X, remaining columns = Y series)
and produces a ChartSpec with per-series x and y arrays.
"""
...
def analyze_scatter(kw: dict) -> ChartSpec:
    """Analyze scatter plot data and return a ChartSpec.
