"""FastAPI server for Spectra — serves Plotly chart specs
...
def _make_app():
    ...
    api = FastAPI(title="Spectra API", version="1.0.0")
    ...
    UPLOAD_DIR = os.path.join(tempfile.gettempdir(), "spectra-uploads")
